    ...
    Public Sub getOrdenes()
        ...
        Try
            ...
            For Each row As DataRow In dsOrdenes.Tables("lecturas").Rows
                ...
                Dim ls_poliza As String = row("numOrden").ToString.PadLeft(obtieneLongitud(conn, "poliza"), "0")
                ...
                Dim nombreFinal As String = mostrarImagenes(Server.MapPath("~/") & "fotos\", "*" & serieMedidorRaw & "-" & fechaFinal, ls_poliza & "-*" & serieMedidor)
