            ...
            <div id="emp" runat="server" style="width: 100%; display: inline-block">
                <div style="width: 50%; float: left">
                    <div style="width:100%; float:left">
                        <asp:Label ID="Label6" runat="server" style="margin-left: 20%;margin-top:35px;">Filtrar por Centro</asp:Label>
                        &nbsp;&nbsp;
                        <asp:DropDownList ID="ddl_FiltroEmp" runat="server" AutoPostBack="True" Height="25px" style="margin-top:35px;" Width="146px">
                        ...
                        <br />
                        <br />
                        <asp:ListBox ID="lbEmpleados" runat="server" AutoPostBack="true" HorizontalContentAlignment="Stretch" style="height:150px !important; margin-bottom:35px; top: 0px; left: 0px;"></asp:ListBox>
                    </div>
                </div>
                <div id="datos" runat="server" style="width: 50%; float: left">
                    ...
                    <br />
                    <br />
                    <asp:Label ID="Label7" runat="server" height="21px" Text="Central:" width="130px"></asp:Label>
                    <asp:DropDownList ID="lstcentral" runat="server" Height="25px" Width="146px">
                        <asp:ListItem Value="CE000">Sin Definir</asp:ListItem>
                        <asp:ListItem Value="CE001">Tampico</asp:ListItem>
                        <asp:ListItem Value="CE002">Madero</asp:ListItem>
                    </asp:DropDownList>
