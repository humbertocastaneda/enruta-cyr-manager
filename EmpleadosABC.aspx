            ...
            <div id="cabecera">
                ...
                <div id="emp" runat="server" style="width:100%; display:inline-block">
                     <div style="width:50%; float:left">
                         <asp:Label style="margin-left: 20%;margin-top:35px;" runat="server">Filtrar por Centro</asp:Label> &nbsp;&nbsp;
                         
                         <asp:DropDownList style="margin-top:35px;" ID="ddl_FiltroEmp" runat="server" Height="25px" Width="146px" AutoPostBack="True">
                ...
                <div id="datos" runat="server" style="width:50%; float:left">
                    ...
                    <br /> <br />
                  <asp:Label ID="Label6" runat="server" Text="Central:" width="130px" height="21px" ></asp:Label> &nbsp;
                      <!--SM 29-08-2014-->
