...
Partial Class _Default
    ...
    Sub getResumen()
        ...
        Dim sqlSelect As String = "Select concat_ws(' ', nombre, appat, apmat) nombre, emp.Remociones, (select count(*) from lecturas ord where ord.tipoLectura='' and tar.idTarea=ord.idTarea and emp.idEmpleado=tar.idEmpleado) desconexiones, emp.Reconexiones, emp.recremos, " & _
