...
Partial Class _Default
    ...
    Public cantidad_total_disco As String = ""
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        End If
        cantidad_total_disco = ShowFreeSpace()
        Me.DataBind()
    ...
    Function ShowFreeSpace() As String
        Dim fs As Object


        fs = CreateObject("Scripting.FileSystemObject")
        Dim d = fs.GetDrive(fs.GetDriveName(Server.MapPath("~/").Substring(0, 2)))
        ShowFreeSpace = Server.MapPath("~/").Substring(0, 2) & " " & Math.Round(d.FreeSpace / 1048576, 2)
    End Function
End Class
