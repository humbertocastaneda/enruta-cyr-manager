...
Partial Class verOrdenesPorEmpleado
    ...
    Public Sub getOrdenes()
        ...
        Try
            ...
            'generaArchivoPuntosRuta(dsOrdenesRuta, dsOrdenes, User.Identity.Name & "rutados_" & getFecha("HHmmss"))
    ...
    Public Sub generaArchivoPuntos(ds As DataSet, nombreArchivo As String)
        ...
        b_verMapa.Attributes.Clear()
        b_verMapa.Attributes.Add("onclick", "window.open('http://maps.google.com/maps?q=http://www.cortrexweb.com/tampico/uploads/" & nombreArchivo & "." & ext & "'" & "); return false;")
    ...
    Public Sub generaArchivoPuntosRuta(ds As DataSet, nombreArchivo As String)
        ...
        b_verRuta.Attributes.Clear()
        b_verRuta.Attributes.Add("onclick", "window.open('http://maps.google.com/maps?q=http://www.cortrexweb.com/tampico/uploads/" & nombreArchivo & "." & ext & "'" & "); return false;")
        'b_verRuta.Attributes.Add("onclick", "window.open('http://maps.google.com/maps?q=http://www.espinosacarlos.com/cortrexpruebas/uploads/" & nombreArchivo & "." & ext & "'" & "); return false;")
    ...
    Public Sub generaArchivoPuntosRuta(ds As DataSet, ds2 As DataSet, nombreArchivo As String)
        ...
        ver_recorridoruta.Attributes.Add("onclick", "window.open('http://maps.google.com/maps?q=http://www.cortrexweb.com/tampico/uploads/" & nombreArchivo & "." & ext & "'" & "); return false;")
    ...
    Public Sub generaArchivoPuntosLocalizar(ds As DataSet, nombreArchivo As String)
        ...
        b_localizar.Attributes.Add("onclick", "window.open('http://maps.google.com/maps?q=http://www.cortrexweb.com/tampico/uploads/" & nombreArchivo & "." & ext & "'" & "); return false;")
    ...
    Protected Sub bEnviar_Click(sender As Object, e As EventArgs) Handles bEnviar.Click
        ...
        Try
            ...
            'End If
            Dim condiciones As String = "1=1"
            If ck_PorUsuario.Checked Then
                condiciones = "emp.idEmpleado = " & gv_tecnicos.SelectedRow.Cells(1).Text
            End If
            ...
            selectSQL = "select  emp.nomina idEmpleado, ord.idTarea,  ord.idOrden idOrden, if(ord.estadoDeLaOrden='EO001', true, false) asignar , cli.entreCalles " & _
                        ...
                        " and " & condiciones & "  and ord.estadodelaorden ='EO001' and tar.fechadeasignacion between STR_TO_DATE('" & dia.Text & "', '%Y%m%d%') and " & " STR_TO_DATE('" & dia2.Text & "', '%Y%m%d%')   " & _
            ...
            message_generico("Ordenes enviadas al celular.")
