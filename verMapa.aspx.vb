    ...
    Sub verPuntosConRuta(ds As DataSet)
        ...
        For Each row As DataRow In ds.Tables("Ordenes").Rows
            ...
            If Not IsDBNull(row.Item("latitud")) Then
                ...
                markers &= GetMarkers(i, row.Item("latitud"), row.Item("longitud"), "http://maps.google.com/mapfiles/kml/paddle/blu-circle_maps.png", "<b>IC " & row.Item("poliza") & " " & row.Item("calle") & " " & row.Item("colonia") & "</b> <br>Fecha de Ejecucion " & row.Item("fechadeejecucion"))
                centro = row.Item("latitud") & ", " & row.Item("longitud")
            End If
