<%@ Page Language="VB" AutoEventWireup="false" CodeFile="verCambiosDeMedidor.aspx.vb"
    Inherits="_Default" %>
...
<head id="Head1" runat="server">
    ...
    <title>Cambios De Medidor</title>
...
<body>
    ...
    <div id="pagina">
        ...
        <div id="contenido">
            ...
            <br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Fecha:
            <asp:TextBox ID="fecha1" runat="server" ToolTip="AñoMesDía (20001231)"></asp:TextBox>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="fecha1"
                ...
                Font-Size="12px"></asp:RegularExpressionValidator>&nbsp; a &nbsp;
            <asp:TextBox ID="fecha2" runat="server" ToolTip="AñoMesDía (20001231)"></asp:TextBox>&nbsp;&nbsp;&nbsp;
            ...
            <asp:DataGrid ID="dgOrdenes" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateColumn HeaderText="Id">
                        <ItemTemplate>
                            <asp:LinkButton ID="hlNumOrden" runat="server" OnClick="LinkButton_Click" Text='<%# Container.DataItem("idLectura")%>'></asp:LinkButton>
                            &nbsp;&nbsp;
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    ...
                    <asp:BoundColumn DataField="serieMedidor" HeaderText="Medidor en Campo"></asp:BoundColumn>
                    <asp:BoundColumn DataField="serieMedidor2" HeaderText="Medidor en Sistema"></asp:BoundColumn>
