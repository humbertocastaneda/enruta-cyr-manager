            ...
            <div id="ordenes">
                ...
                <div style="width: 100%; float: left; height: auto">
                    ...
                    <asp:DropDownList ID="ddl_motivos" runat="server">
                        ...
                        <asp:ListItem Value="9">Consumo Excesivo</asp:ListItem>
                        <asp:ListItem Value="10">Consumo Cero</asp:ListItem>
                        <asp:ListItem Value="11">Consumo Negativo</asp:ListItem>
                        <asp:ListItem Value="12">Casa Cerrada</asp:ListItem>
                    </asp:DropDownList>
        ...
        <div id="contenido">
            ...
            <asp:DataGrid ID="dgOrdenes" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="poliza" HeaderText="Contrato" />
                    <asp:BoundColumn DataField="ubicacion" HeaderText="Clave Ubicacion" />
                    <asp:BoundColumn DataField="estadoDeLaOrden" HeaderText="Estado de la Lectura" />
                    <asp:BoundColumn DataField="serieMedidor" HeaderText="Número de Medidor" />
                    <asp:TemplateColumn HeaderText="Dirección">
                        <ItemTemplate>
                          <asp:label runat="server"> <%# Container.DataItem("direccion")%>, <%# Container.DataItem("colonia")%></asp:label>
                        </ItemTemplate>
                    </asp:TemplateColumn>
