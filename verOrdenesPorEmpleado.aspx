<%@ Page Language="VB" AutoEventWireup="false" CodeFile="verOrdenesPorEmpleado.aspx.vb"
        ...
        <div id="navegador">
            ...
            <div id="ordenes">
                ...
                <div style="width: 100%; float: left; height: auto">
                    <asp:CheckBox ID="ck_PorUsuario" Text="Filtrar por Usuario" Checked="true" runat="server" />
                    <br />
            ...
            <!--SM 29-08-2014-->
                    ...
                    <asp:Button ID="Button1" runat="server" OnClientClick="nuevaVentana()" Text="Vista Captura" />
                    <asp:Button ID="bBajarFotos" runat="server" Text="Bajar fotografias" />
                    <asp:Button ID="bAExcel" runat="server" Text="Exportar" />
                    <asp:Button ID="b_verMapa" runat="server" Text="Ver Mapa" />
                    <asp:Button ID="b_verRuta" runat="server" Text="Ver Ruta" />
                    <asp:Button ID="b_imprimir" runat="server" Text="Imprimir" />
                    <asp:Button ID="ver_recorridoruta" runat="server" Text="Ver Recorrido y Ordenes" Visible="False" />
                    <asp:Button ID="b_localizar" runat="server" Text="Localizar Tecnicos" Visible="False" />
                </div>
            </div>
        </div>
        <div id="contenido">
            <asp:DataGrid ID="dgOrdenes" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn  HeaderText="Tipo de Orden">
                        <ItemTemplate>
                            <asp:Label ID="Label2"
                                runat="server" Text='<%#getTipoOrden(Container.DataItem("tipoDeOrden"))%>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="6%" />
                        <HeaderStyle  Width="6%" />
                    </asp:TemplateColumn>
                    ...
                    <asp:TemplateColumn HeaderText="Colonia">
                        <ItemTemplate>
                            <asp:Label ID="Label33"  runat="server" Text='<%#Container.DataItem("colonia") & "<br>" & Container.DataItem("municipio")%>'></asp:Label>
                    ...
                    <asp:TemplateColumn HeaderText="Direccion">
                        <ItemTemplate>
                            <asp:Label ID="Label3"  runat="server" Text='<%#Container.DataItem("calle") & " #" & Container.DataItem("numInterior")%>'></asp:Label>
                    ...
                    <asp:BoundColumn DataField="numMedidor" HeaderText="Número de Medidor" >
                     ...
                     <asp:BoundColumn DataField="accionCorte" HeaderText="Accion" >
                         <ItemStyle Width="6%" />
                        <HeaderStyle  Width="6%" />
                         </asp:BoundColumn>
