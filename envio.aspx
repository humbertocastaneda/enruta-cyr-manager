        ...
        <div id="contenido" align="center">
            ...
            <div style="width: 70%; height: 50%; margin: auto 0px">
                ...
                <div style="text-align: right; width=50%">
                    ...
                    <asp:Button ID="b_decargar0" runat="server" Text="Descargar CSV" CssClass="buttongrl" />
                </div>
                <br />
                <div align="left" style="float: left; width:100%">
                    <asp:Label ID="Label6" runat="server" height="21px" Text="Central:" width="130px"></asp:Label>
                ...
                <div align="left" style="position: static; float: none; ">
                    ...
                    <div style="text-align: right">
                        <asp:Button ID="bEliminar" runat="server" Text="Eliminar" CssClass="buttongrl" /></div>
                    <br />
                    <br />
