<%@ Page Language="VB" AutoEventWireup="false" CodeFile="asignacion.aspx.vb" Inherits="_Default"
...
<body>
    ...
    <div id="pagina">
        ...
        <div id="navegador">
            ...
            <div id="ordenes">
                &nbsp;<div style="width: 100%; margin-bottom: 1px; height: 128px">
                    <div style="width: auto; float: left; height: 27px;">
                        ...
                        <asp:Button ID="bFiltrar" Style="margin-right: 10px" runat="server" Text="Filtrar"
                            CssClass="buttongrl" />
                        <asp:Button ID="bSeleccionar" runat="server" Text="Seleccionar" CssClass="buttongrl" />
                        <asp:Button ID="bDeseleccionar" runat="server" Text="Deseleccionar" CssClass="buttongrl" />
                        <asp:Button ID="bAceptar" runat="server" Font-Names="Segoe UI" Text="Guardar" CssClass="buttongrl" />
                        <asp:Button ID="bEnviar" runat="server" Font-Names="Segoe UI" Text="Enviar al Celular"
                            OnClientClick="return alertaNoTodasAsignadas()" CssClass="buttongrl" />
                ...
                <div style="width: 100%; float: left; height: 20px; margin-bottom: 13px;">
                    <asp:CheckBox ID="cbModoSeleccion" runat="server" Checked="true" Font-Names="Segoe UI"
                        Text="Modo Selección" />
                </div>
            </div>
        </div>
        <div id="contenido">
            ...
            <div style="width: 878px; margin-left: 14px; margin-right: 25px; margin-top: 14px;
                margin-bottom: 21px; position: static; float: Left;">
            ...
            <asp:DataGrid ID="dgOrdenes" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateColumn>
                        <ItemTemplate>
                            <asp:CheckBox ID="cbAsignadas" runat="server" Checked='<%# Container.DataItem("asignada")%>'
                                AutoPostBack="false" />
                            <asp:Label ID="lbIdOrden" runat="server" Text='<%# Container.DataItem("idOrden")%>'
                                Visible="false" />
                            &nbsp;&nbsp;
                        </ItemTemplate>
                    </asp:TemplateColumn>
    ...
    <div align="center" class="footer" style="position: fixed; height: 5%; width: 100%;
        bottom: 0; background-color: #004FC4; left: -5px; right: 5; color: #FFFFFF;">
