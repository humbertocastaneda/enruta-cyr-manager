...
Partial Class _Default
    ...
    Public ls_tipoDeOrden, ls_numOrden, ls_estadoDeLaOrden, ls_motivo, ls_fechaDeEjecucion, _
    ...
    Public Sub setImagenes(conn As MySqlConnection)
        ...
        mostrarImagenes(Server.MapPath("~/") & "fotos\", nombreGenerico, ls_numOrdenReal & "_" & ls_poliza & fechaFinal)
