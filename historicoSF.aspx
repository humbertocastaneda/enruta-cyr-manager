    ...
    <form id="form1" runat="server">
        ...
        <div id="pagina">
            ...
            <div id="contenido" >
                    ...
                    <br />
                    Seleccione la fecha de la cual desea hacer un respaldo de las fotos<br />
                    ...
                    <div style="text-align: left">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtfecha" Display="Dynamic" ErrorMessage="* Error (AñoMesDía)" Font-Names="Segoe UI" Font-Size="12px" ForeColor="Red" SetFocusOnError="True" ValidationExpression="^\d{4}((0[1-9])|(1[012]))((0[1-9]|[12]\d)|3[01])$"></asp:RegularExpressionValidator>
                        <asp:Button ID="b_decargar0" runat="server" Text="Seleccionar" />&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="Button1" runat="server" OnClientClick="return alertaNoTodasAsignadas()" Text="Eliminar" />
                    </div>
                    ...
                    <hr />
                    <br />
                    Seleccione el rango de fechas de cual desea obtener la informacion<br />
                    <br />
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="dia"
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="dia2"
                                ...
                                Display="Dynamic" ForeColor="Red" SetFocusOnError="True" Font-Names="Segoe UI"
                                Font-Size="12px"></asp:RegularExpressionValidator>
                            <asp:Button ID="bSap" runat="server" Text="Descargar Archivo SAP" />
                &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="bInfoAExcel" runat="server" Text="Descargar Excel" />
