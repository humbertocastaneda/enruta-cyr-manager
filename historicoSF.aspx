...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function alertaBorrar() {
            ...
            return confirm("Esta a punto de borrar todos los datos en el sistema ¿Desea continuar?");
        ...
        <div id="pagina">
            ...
            <div id="contenido" runat="server">
                    ...
                    <div style="text-align: left">
                        ...
                        <asp:Button ID="Button1" OnClientClick="return alertaNoTodasAsignadas()" runat="server" Text="Eliminar Fotos" />
                        <br />
                        <br />
                        <br />
                        <br />
                        <asp:Button ID="Button2" OnClientClick="return alertaBorrar()" runat="server" Text="Eliminar Todos los Datos" />
