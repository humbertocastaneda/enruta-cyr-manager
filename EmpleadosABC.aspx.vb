...
Partial Class _Default
    ...
    Public Sub actualizaListaTecnicos()
        ...
        Try
            ...
            Dim selectSQL = "Select idEmpleado idEmpleado ,  if(isnull(alias) or LENGTH(alias)=0, CONCAT_WS(' ',nombre,  appat, apmat), alias) nombreCompleto  from empleadoslect where " & getCentroLectura() & " order by if(isnull(alias) or LENGTH(alias)=0, CONCAT_WS(' ',nombre,  appat, apmat), alias)"
    ...
    Protected Sub setDatos(idEmpleado As String)
        ...
        Try
            ...
            Dim selectSQL = "Select idempleado, centro , CONCAT_WS(' ', nombre, appat, apmat)nombreCompleto, nombre, appat, apmat, alias, nomina, estado  from empleadoslect where idempleado=" & idEmpleado
    ...
    Protected Sub ib_guardar_Click(sender As Object, e As EventArgs) Handles ib_guardar.Click
        ...
        Try
            ...
            Else
                ls_statement = "insert into empleadoslect( nombre, appat, apmat, nomina, alias, estado, centro) values " & _
                    "('" & txtNombre.Text & "'" & _
