                        ...
                        If ds.Tables(0).Rows.Count > 0 Then
                            ...
                            If actualizar Then
                                ...
                                ", fechaCargaOrdenServidor=str_to_date('" & fechadeRecepcionServidor & "', '%Y%m%d%H%i%s') " & _
                                    ", habitado=" & habitado & ", enviada='EE001', comentarios=" & comentarios & ", idTarea=" & idTarea & ", numSello=" & numSello & ", estadoAnterior='" & estadoAnterior & "', latitud=" & latitud & ", longitud=" & longitud & " where idOrden=" & ds.Tables(0).Rows(0).Item("idOrden")
