                    ...
                    While (Not reader.EndOfStream)
                        Try
                            ...
                            Else
                                ...
                                foto = ls_linea.Substring(135, 48).Trim

                                Dim ls_update As String = "Insert into noregistrados  (calle, colonia, comentarios, lectura, seriemedidor, esferas,fechaDeIngresoAlSistema, foto) " & _
                                    " values ( '" & direccion & "', '" & colonia & "', '" & comentarios & "','" & lectura & "', '" & medidor & "'," & numEsferas & ", str_to_date('" & paginaGenerica.getFecha("ddMMyyyy") & "', '%d%m%Y'), '" & foto & "' )"
