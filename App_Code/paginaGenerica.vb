...
Public Class paginaGenerica
    ...
    Public Sub getCadenaAEscribir(lsOrden As String, tipo As String, conn As MySql.Data.MySqlClient.MySqlConnection)
        ...
        Dim resultado As String = ""
        Dim selectSQL As String = "Select  cli.colonia, ord.poliza economico,substr(emp.nomina, -4) nombreArchivo, cli.nombre cliente, ord.idlectura poliza,  ord.diametro_toma, cli.tarifa, ord.giro,  cli.direccion, ord.serieMedidor, ord.marcaMedidor, emp.nomina nomina, cli.sectorCorto,  ord.numEsferas numEsferas " & _
        ...
        If dsOrdenes.Tables("lecturas").Rows.Count Then
            ...
            resultado &= "0".ToString.PadLeft(obtieneLongitud(conn, "lectura"), "0")    'lecturaMinima
            resultado &= "99999999".ToString.PadLeft(obtieneLongitud(conn, "lectura"), "0") 'LecturaMaxima
